...
public class AlunoWindow extends JFrame {
	...
	private void buscarAlunos() {
		...
		for (Aluno aluno : alunos) {
			...
			modelo.addRow(new Object[] { aluno.getRegistroAcademico(), aluno.getNome(), aluno.getSexo(),
					aluno.getCurso().getNome(), aluno.getDataIngresso(), aluno.getPeriodo(), aluno.getCoeficiente() });
		}
	}
